...
<body>
	...
	<center><b>10. LIVING WITH PARENTS/GUARDIAN</center>
		...
		<TR bgcolor='#E5F4F4'>
			<TD><i><font color='blue'>(a) Name of the Parent / Guardian</i></TD>
			<TD><center><input type="text" name="fname" value="<?php echo $row['fname'];?>" required maxlength="50"></center></TD>
		</TR>

		<TR bgcolor='#E5F4F4'>
			<TD><i><font color='blue'>(b) Parent / Guardian's Occupation</i></TD>
			<TD><center><textarea name="f_ed_qua" rows="4" cols="27" required maxlength="100"><?php echo $row['f_ed_qua'];?></textarea></center></TD>
		</TR>

		<TR bgcolor='#E5F4F4'>
			<TD><i><font color='blue'>(c) Full Address with Contact No.</i></TD>
			<TD><center><textarea name="f_add_pin_phno" rows="4" cols="25" required maxlength="100"><?php echo $row['f_add_pin_phno'];?></textarea></center></TD>
		</TR>
